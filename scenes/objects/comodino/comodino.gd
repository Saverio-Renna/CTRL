...
var textBox = [
	"Dovrei richiamare i miei per dare la conferma per stasera…",
...
var choices = [
	"Ci penserò dopo… forse. (Non fare nulla per ora )",
	"Ok, lo faccio. Almeno lo tolgo dalla testa. (Chiama e dai conferma)",
	"Meglio essere onesto, oggi non è giornata (Chiama e avverti che non vai)"
] 
