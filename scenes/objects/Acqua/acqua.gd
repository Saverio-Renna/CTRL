...
var textBox = [
	"Devo bere qualcosa… ma anche questo sembra complicato."
]
var anxiety_up = 20
var anxiety_down = -10
...
var choices = [
	"Non mi va ora (Lasci il bicchiere pieno sul tavolo)",
	"Devo farlo, non bevo da troppo (Bevi un bicchiere intero con calma)",
	"ti forzi a vere (bevi mezzo bicchiere)" 
] 
